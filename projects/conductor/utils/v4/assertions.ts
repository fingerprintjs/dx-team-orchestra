...
interface ThatResponseMatchParams {
  ...
  callback: (api: FingerprintV4Api) => Promise<JsonResponse<unknown>>
  strict?: boolean
}

export class AssertionsV4 {
  constructor(
    private readonly fingerprintApi: FingerprintV4Api,
    private readonly sdksApi: FingerprintV4Api
  ) {}
   ...
   * @param {...Parameters<FingerprintV4Api[Method]>} params - The parameters to pass to the specified method.
   * @return {Promise<void>} Resolves when the comparison is complete and the responses match.
   */
  async thatResponsesMatch<Method extends keyof FingerprintV4Api>(
    method: Method,
    ...params: Parameters<FingerprintV4Api[Method]>
  ): Promise<ExtractFingerprintV4ApiReturnType<Method>> {
